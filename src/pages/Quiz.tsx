...
const Quiz = () => {
  ...
  const { incrementActivity } = useTimeTracking({ pageName: 'quiz' });
      ...
      <div className="container mx-auto p-6">
        <Card className="max-w-2xl mx-auto">
          <CardHeader className="text-center">
            ...
            <CardDescription>Great job completing {currentGame.title}</CardDescription>
          </CardHeader>
    ...
    <div className="container mx-auto p-6">
      <div className="space-y-6">
        <div className="text-center">
          <h1 className="text-3xl font-bold text-primary mb-2">Quiz Challenge</h1>
          <p className="text-muted-foreground">Test your Gujarati knowledge!</p>
        </div>
        ...
        {quizzes.length === 0 ? (
          <Card className="text-center p-8">
            ...
            <CardDescription>Quizzes will be added by teachers soon!</CardDescription>
          </Card>
        ) : (
                ...
                <Card key={quiz.id} className="cursor-pointer hover:shadow-lg transition-shadow">
                  ...
                  <CardContent>
                    <div className="space-y-3">
                      ...
                      >
                        {isCompleted ? 'Take Again (No Points)' : 'Start Quiz'}
                      </Button>
                    </div>
                  </CardContent>
                </Card>
